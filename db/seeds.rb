...
second_post = Post.create(author_id: first_user.id, title: 'Hi there', text: 'This is my second post')
third_post = Post.create(author_id: first_user.id, title: 'Holaaa', text: 'This is my third post')
fourth_post = Post.create(author_id: second_user.id, title: 'Hello', text: 'This is my first post')
fifth_post = Post.create(author_id: second_user.id, title: 'Hey hey', text: 'This is my second post')
sixth_post = Post.create(author_id: second_user.id, title: 'Testing', text: 'This is my third post')
seventh_post = Post.create(author_id: third_user.id, title: 'Checking', text: 'This is my first post')
eight_post = Post.create(author_id: third_user.id, title: 'Another day to slay', text: 'This is my second post')
nineth_post = Post.create(author_id: third_user.id, title: 'favorites', text: 'This is my third post')
